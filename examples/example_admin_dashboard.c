        ...
        static void* generate_ai_traffic(void* arg)
        {
            ...
            static void* generate_security_traffic(void* arg)
            {
                ...
                int main()
                {
                    ...
                    pthread_create(&mq_timer, NULL, generate_bg_traffic, mq_data);
                    ...
                    pthread_t sec_timer;
                    pthread_create(&sec_timer, NULL, generate_security_traffic, NULL);

                    /* Background HTTP Traffic Timer */
                    pthread_t http_timer;
                    pthread_create(&http_timer, NULL, generate_http_traffic, NULL);
