...
target_link_libraries(csilk_db PUBLIC csilk_core SQLite::SQLite3 CURL::libcurl)
...
if(CSILK_BUILD_SHARED)
    ...
    target_link_libraries(csilk_db_shared PUBLIC csilk_core_shared SQLite::SQLite3 CURL::libcurl)
    foreach(DB_TARGET csilk::mysql csilk::pq csilk::hiredis csilk::mongoc)
      if(TARGET ${DB_TARGET})
