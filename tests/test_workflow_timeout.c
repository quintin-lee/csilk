...
csilk_data_t* slow_handler(csilk_wf_ctx_t* ctx, csilk_data_t* input,
                           void* user_data) {
  (void)ctx;
  (void)input;
  (void)user_data;
...
csilk_data_t* timeout_fallback_handler(csilk_wf_ctx_t* ctx, csilk_data_t* input,
                                       void* user_data) {
  (void)ctx;
  (void)input;
  (void)user_data;
...
void test_workflow_node_timeout() {
  ...
  csilk_wf_node_t* nf =
      csilk_wf_add(wf, "fallback", timeout_fallback_handler, NULL);
