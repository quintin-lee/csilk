...
test_sha1_rfc3174_2()
{
	...
	csilk_sha1_init(&ctx);
	csilk_sha1_update(&ctx,
			  (uint8_t*)"abcdbcdecdefdefgefghfghighij"
				    "hijkijkljklmklmnlmnomnopnopq",
			  56);
	csilk_sha1_final(&ctx, digest);

	uint8_t expected[] = {0x84, 0x98, 0x3E, 0x44, 0x1C, 0x3B, 0xD2, 0x6E, 0xBA, 0xAE,
...
test_sha1_empty()
{
	...
	uint8_t expected[] = {0xDA, 0x39, 0xA3, 0xEE, 0x5E, 0x6B, 0x4B, 0x0D, 0x32, 0x55,
...
test_sha1_single_char()
{
	...
	uint8_t expected[] = {0x86, 0xF7, 0xE4, 0x37, 0xFA, 0xA5, 0xA7, 0xFC, 0xE1, 0x5D,
