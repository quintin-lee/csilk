...
static void handler_that_panics(csilk_ctx_t* c) { csilk_panic(c); }

static void test_recovery_handler_catches_panic() {
...
static void normal_handler(csilk_ctx_t* c) { normal_handler_called = 1; }

static void test_recovery_handler_normal_flow() {
