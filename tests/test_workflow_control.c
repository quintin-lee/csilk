...
csilk_data_t* mock_handler(csilk_wf_ctx_t* ctx, csilk_data_t* input,
                           void* user_data) {
  (void)ctx;
  (void)input;
  (void)user_data;
...
csilk_data_t* failing_handler(csilk_wf_ctx_t* ctx, csilk_data_t* input,
                              void* user_data) {
  (void)ctx;
  (void)input;
  (void)user_data;
...
csilk_data_t* fallback_handler(csilk_wf_ctx_t* ctx, csilk_data_t* input,
                               void* user_data) {
  (void)ctx;
  (void)input;
  (void)user_data;
...
void test_workflow_error_branch() {
  ...
  csilk_wf_node_t* n_fallback =
      csilk_wf_add(wf, "fallback", fallback_handler, NULL);
...
csilk_data_t* start_router_handler(csilk_wf_ctx_t* ctx, csilk_data_t* input,
                                   void* user_data) {
  (void)user_data;
  return csilk_wf_data_new(ctx, "text",
                           csilk_wf_strdup(ctx, (char*)input->value));
}

csilk_data_t* magic_handler(csilk_wf_ctx_t* ctx, csilk_data_t* input,
                            void* user_data) {
  (void)ctx;
  (void)input;
  (void)user_data;
...
void test_workflow_dynamic_route() {
  ...
  csilk_wf_node_t* n_start =
      csilk_wf_add(wf, "start", start_router_handler, NULL);
...
csilk_data_t* fast_handler(csilk_wf_ctx_t* ctx, csilk_data_t* input,
                           void* user_data) {
  (void)user_data;
...
csilk_data_t* or_join_handler(csilk_wf_ctx_t* ctx, csilk_data_t* input,
                              void* user_data) {
  (void)ctx;
  (void)input;
  (void)user_data;
