...
csilk_data_t* step_a_handler(csilk_wf_ctx_t* ctx, csilk_data_t* input,
                             void* user_data) {
  (void)input;
  (void)user_data;
  g_step_a_ran++;
  ...
  return csilk_wf_data_new(ctx, "text/plain",
                           csilk_wf_strdup(ctx, "output_from_a"));
}

csilk_data_t* step_b_handler(csilk_wf_ctx_t* ctx, csilk_data_t* input,
                             void* user_data) {
  (void)user_data;
  g_step_b_ran++;
