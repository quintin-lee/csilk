...
csilk_data_t* invalid_json_handler(csilk_wf_ctx_t* ctx, csilk_data_t* input, void* user_data) {
    (void)input; (void)user_data;
    printf("[Producer] Returning JSON missing 'required' field\n");
    return csilk_wf_data_new(ctx, "application/json", csilk_wf_strdup(ctx, "{\"wrong\": \"field\"}"));
}

csilk_data_t* schema_fallback_handler(csilk_wf_ctx_t* ctx, csilk_data_t* input, void* user_data) {
