...
static void mid_handler(csilk_ctx_t* c) {
  mid_called++;
  csilk_next(c);
}
...
int main() {
  ...
  printf("Testing csilk_app_add_route_extended...\n");
  {
    csilk_app_t* app = csilk_app_new(NULL);
    assert(app != NULL);
    csilk_app_add_route_extended(app, "GET", "/extended", hello_handler,
  ...
  printf("Testing csilk_app_add_route_extended_perm...\n");
  {
    csilk_app_t* app = csilk_app_new(NULL);
    assert(app != NULL);
    csilk_app_add_route_extended_perm(app, "DELETE", "/extperm/:id",
                                      hello_handler, NULL, NULL, "Del",
                                      "Delete", "admin", "users");
    csilk_ctx_t ctx = {0};
  ...
  printf("Testing csilk_app_add_route_perm...\n");
  {
    csilk_app_t* app = csilk_app_new(NULL);
    assert(app != NULL);
    csilk_app_add_route_perm(app, "GET", "/perm", hello_handler, "read",
                             "documents");
    csilk_ctx_t ctx = {0};
    ctx.request.method = "GET";
  ...
  printf("Testing csilk_app NULL safety...\n");
  {
    ...
    csilk_app_add_route_extended(NULL, "GET", "/nope", hello_handler, NULL,
                                 NULL, NULL, NULL);
    csilk_app_add_route_extended_perm(NULL, "GET", "/nope", hello_handler, NULL,
