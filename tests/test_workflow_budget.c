...
/* --- Mock Handlers --- */
csilk_data_t* expensive_handler(csilk_wf_ctx_t* ctx, csilk_data_t* input, void* user_data) {
...
csilk_data_t* skip_handler(csilk_wf_ctx_t* ctx, csilk_data_t* input, void* user_data) {
