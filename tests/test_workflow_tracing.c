...
csilk_data_t* t_step_handler(csilk_wf_ctx_t* ctx, csilk_data_t* input,
                             void* user_data) {
  (void)user_data;
...
void on_trace_complete(csilk_data_t* result, csilk_wf_trace_t* trace) {
  (void)result;
...
void test_workflow_tracing() {
  ...
  csilk_wf_node_t* n1 =
      csilk_wf_add(wf, "node1", t_step_handler, "node1_output");
  csilk_wf_node_t* n2 =
      csilk_wf_add(wf, "node2", t_step_handler, "node2_output");
  csilk_wf_bind(n1, n2);
