...
void test_db_sqlite_create_table(void) {
  csilk_db_init();
...
void test_db_sqlite_insert_query(void) {
  csilk_db_init();
  ...
  cJSON* result = csilk_db_query_param_json(
      pool, "INSERT INTO users (name) VALUES (?)", params);
...
void test_db_sqlite_transactions(void) {
  csilk_db_init();
