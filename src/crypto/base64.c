...
csilk_base64url_decode(const char* src, uint8_t* out, size_t out_cap)
{
    ...
    static const int8_t b64_rev_table[256] = {
        ...
        -1,
        -1,
        /* 0x20 - 0x3F: '+' is 0x2B (62), '/' is 0x2F (63), '0'-'9' are 0x30-0x39 (52-61) */
        -1,
        -1,
        -1,
        -1,
        ...
        -1,
        -1,
        /* 0x40 - 0x5F: 'A'-'Z' are 0x41-0x5A (0-25) */
        -1,
        0,
        1,
        2,
        ...
        -1,
        -1,
        /* 0x60 - 0x7F: 'a'-'z' are 0x61-0x7A (26-51) */
        -1,
        26,
        27,
        28,
        ...
        -1,
        -1,
        /* 0x80 - 0xFF: High bytes are all invalid (-1) */
        -1,
        -1,
        -1,
        -1,
